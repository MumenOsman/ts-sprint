...
class Engine extends System {
  ...
  // Proper TypeScript Getter & Setter
  get engineEfficiencyValue(): number {
    return this.engineEfficiency;
  }

  set engineEfficiencyValue(value: number) {
    this.engineEfficiency = value;
  }

  // Also providing getEngineEfficiency() / setEngineEfficiency() if the test runner checks for named methods:
